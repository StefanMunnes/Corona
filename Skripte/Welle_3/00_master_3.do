...
*** Datensatz laden (Welle 3, 03.06.2020 - 03.08.2020)
use "Daten/Rohdaten/Welle_3/data_20200803.dta", clear
...
do "Skripte/Welle_3/01_rec_vars.do"

* Offene Antworten kodieren: q11reason q11compen
foreach var in q04 q11compen q11reason q12 q17 q25otherhhmem q25otherplace q32 {
	do "Skripte/Welle_3/02_rec_opn_`var'.do"
}

* Unplausible Fälle rekodieren/löschen
do "Skripte/Welle_3/03_valid_cases.do"

* Fehlende Werte rekodieren (Abbrecher, Filter)
do "Skripte/Welle_3/04_rec_miss.do"

* Neue Variablen erstellen
do "Skripte/Welle_3/05_gen_vars.do"

* Variablen beschriften
do "Skripte/Welle_3/06_lab_vars.do"
...
compress
save "Daten/Arbeitsdaten/corona_3_de.dta", replace
